...
module.exports = {
  ...
  db: process.env.MONGOLAB_URI || process.env.MONGODB || 'mongodb://selim:Sinai@ds029811.mongolab.com:29811/rahaladb',
  ...
  sendgrid: {
    user: process.env.SENDGRID_USER || 'aselims',
    password: process.env.SENDGRID_PASSWORD || 'Sinai@14'
  },
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1535383766718019',
    clientSecret: process.env.FACEBOOK_SECRET || 'd1c609da0e6e1eb4dbe3c16721356c07',
  ...
  twitter: {
    consumerKey: process.env.TWITTER_KEY || 'zQ26QUDD5TaeKjVDPWJw9ordh',
    consumerSecret: process.env.TWITTER_SECRET  || 'dIBVckx6BIfmW1ZF4d1PJQItt6ddR4DsKm8KZKz1R6NFXJ1763',
    callbackURL: '/auth/twitter/callback',
    passReqToCallback: true
  },

  google: {
    clientID: process.env.GOOGLE_ID || '77036256658-1ohfh2ed0dk4b2ldfi28rvovf9grc25s.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'EacFbxcnO_N-zle-Y3kMfYsb',
